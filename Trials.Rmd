...
1. ◻️ Define coarse graining procedure;
1. ◻️ Community detection;
1. ◻️ Save local copy of results;
1. ◻️ Betweenness, centrality, small world characteristics, distance from random network;
1. ◻️ Plot every measure
